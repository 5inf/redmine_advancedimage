        ...
        if text.present?
          ...
          lines.each do |line|
            ...
            line.scan(regbox) do |match|
              ...
              color=match[4].to_s
              strokeWidth=match[5].to_s
              svgrectangle="<rect x='"+x1+widthunit+"' y='"+y1+heightunit+"' width='"+rectwidth+widthunit+"' height='"+rectheight+heightunit+"' style='fill:blue;stroke:pink;stroke-width:5;fill-opacity:0.1;stroke-opacity:1.0' />"
